...
- Set cwd to the uspecs-using project root and run `softeng.sh action uchange [options]` and follow the instructions in the output how to process {description}.
